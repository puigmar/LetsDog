class SignupCarer{
    ...
    sendAvatarPhoto = (e) => {
        e.preventDefault();
        this.updatePhoto(this.photoCarerAvatarInputFile, this.photoCarerAvatarPreview, '/manage/validate-photo', 'profilePhoto')
    }

    sendBannerProfilePhoto = (e) => {
        e.preventDefault();
        this.updatePhoto(this.photoCarerBannerProfileInputFile, this.photoCarerBannerProfilePreview, '/manage/validate-photo', 'gallery')
    }

    updatePhoto = (inputFile, wrapperPreview, postUrl, previewUrl, objKeyName) => {
    ...
    addCarerData = () => {
        ...
        this.carerData.gallery =  this.photoCarerBannerProfileUrl;
    }
